...
contract RepoIAA {
  ...
  function listMatching(address a) internal constant returns (uint[]) { 
    // this function returns a list of length iaaList.length of 0 and
    // 1 where 0 indicates whether the address of ra or sa of the
    // particular IAA matches the input address
